...
async function getStaticProps() {
  ...
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://nandozares:+1Sempersonalidade@cluster0.cqcw3.mongodb.net/myMeetups?retryWrites=true&w=majority');
  const db = client.db();
